...
OpenLayers.Layer.Vector = OpenLayers.Class(OpenLayers.Layer, {
    ...
    /**
     * APIMethod: getFeaturesBy
     * Given a property value, return matching features in the features array
     *
     * Parameters:
     * property - {String}
     * value - {String}
     *
     * Returns:
     * {<OpenLayers.Feature.Vector>} An array of features corresponding to the given
     * property value or null if there is no such feature.
     */
    ...
    /**
     * APIMethod: getFeaturesById
     * Given a feature id, return the matching features in the features array
     *
     * Parameters:
     * featureId - {String}
     *
     ...
     * featureId or null if there is no such feature.
     */
    getFeaturesById: function(featureId) {
        return this.getFeaturesBy('id', featureId);
    },
    ...
    /**
     * APIMethod: getFeaturesByFid
     * Given a feature fid, return the matching features the features array
     *
     * Parameters:
     * featureFid - {String}
     *
     ...
     * featureFid or null if there is no such feature.
     */
    getFeaturesByFid: function(featureFid) {
        return this.getFeaturesBy('fid', featureFid);
    },
