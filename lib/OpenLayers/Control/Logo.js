...
OpenLayers.Control.Logo = OpenLayers.Class( OpenLayers.Control, {
    ...
    draw: function () {
        ...
        */
        ...
        if (this.logoPaddingLeft) {
            img.style["padding-left"]=this.logoPaddingLeft;
        }
        if (this.logoPaddingRight) {
            img.style["padding-right"]=this.logoPaddingRight;
        }
        if (this.logoPaddingTop) {
            img.style["padding-top"]=this.logoPaddingTop;
        }
        if (this.logoPaddingBottom) {
            img.style["padding-bottom"]=this.logoPaddingBottom;
        }
