...
*/
    ...
    */
    ...
    onZoomClick: function (evt) {
        ...
        if ((button && (button === this.zoomInLink)) || (evt.path[1].id == 'zoomin') || (evt.path[2].id == 'zoomin')) {
            map.zoomIn();
        } else if ((button && (button === this.zoomOutLink)) || (evt.path[1].id == 'zoomout') || (evt.path[2].id == 'zoomout')) {
