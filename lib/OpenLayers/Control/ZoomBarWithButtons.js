   ...
   /**
    ...
    draw: function () {
        ...
        if (!this.buttonWrapper) {
            ...
            eventsInstance.register("click", this, this.onZoomClick);
...
*/
    ...
    getOrCreateLinks: function(el) {
        ...
        if (!zoomIn) {
            ...
            zoomIn.innerHTML = OpenLayers.Util.hideFromOldIE('<svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" version="1.1" preserveAspectRatio="xMidYMid meet" viewBox="0 0 64 64" class="plus icon"><path fill-rule="evenodd" d="m 14,27.5 13.5,0 0,-13.5 9,0 0,13.5 13.5,0 0,9 -13.5,0 0,13.5 -9,0 0,-13.5 -13.5,0 z M 63,32 C 63,49.120827 49.120827,63 32,63 14.879173,63 1,49.120827 1,32 1,14.879173 14.879173,1 32,1 49.120827,1 63,14.879173 63,32z"/></svg>');
            zoomIn.className = "button olControlZoomIn";
        ...
        if (!zoomOut) {
            ...
            zoomOut.innerHTML = OpenLayers.Util.hideFromOldIE('<svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" version="1.1" preserveAspectRatio="xMidYMid meet" viewBox="0 0 64 64" class="minus icon"><path fill-rule="evenodd" d="m 14,27.5 36,0 0,9 -36,0 zM 63,32 C 63,49.120827 49.120827,63 32,63 14.879173,63 1,49.120827 1,32 1,14.879173 14.879173,1 32,1 49.120827,1 63,14.879173 63,32z"/></svg>');
            zoomOut.className = "button olControlZoomOut";
    ...
    */
    ...
    onZoomClick: function (evt) {
        // includes workaround for opera/chrome which provide evt.path, but fail to react on our buttonclick events.
        var button = evt.buttonElement;
        if ((button   && (button === this.zoomInLink)) || 
            (evt.path && ((evt.path[1].id == 'zoomin') || (evt.path[2].id == 'zoomin')))) {
            map.zoomIn();
        } else if ((button && (button === this.zoomOutLink)) || 
                   (evt.path && ((evt.path[1].id == 'zoomout') || (evt.path[2].id == 'zoomout')))) {
            if (map.getZoom() > 3) {   // 43616-70 hack
                map.zoomOut();
            }
        }
    },
