...
OpenLayers.Control.Help = 
    ...
    initialize: function(options) {
        ...
        OpenLayers.Util.extend(OpenLayers.Lang.nb, {
            ...
            'You can navigate using the following keyboard shortcuts:': 'Følgende taster kan brukes til navigasjon:',
            'Press TAB to change selected control. Press ENTER to activate the selected control.': 'Flytt deg rundt i kartets navigasjon ved å bruke TAB-tasten. Velg enkeltfunksjon ved hjelp av ENTER-tasten.'
        });
    ...
    showControls: function () {
        ...
        html += '<h1>' + OpenLayers.Lang.translate('Keyboard shortcuts') + '</h1>';
        ...
        html += '</div>';
        html += '<div class="shortcuts-panel"><table><thead><tr><th scope="col">Tastekombinasjon</th><th scope="col">Funksjon</th></tr></thead><tbody>';
        html += '<tr><td>Ctrl + W</td><td>Fullskjerm</td></tr>';
