...
OpenLayers.Control.Help = 
    ...
    draw: function () {
        ...
        var html = '';
        html += '<h4>Hvordan bruker jeg «Mitt turkart»?</h4>';
        html += '<ol>';
        html += '<li>Søk etter, eller zoom inn på ønsket område.</li>';
        html += '<li>Flytt kartet slik at det gule rutenettet dekker det området du ønsker kartet skal inneholde.</li>';
        html += '<li>Velg målestokk.</li>';
        html += '<li>Gi kartutsnittet ditt et navn. Dette navnet vil stå på første side av utskriften din.</li>';
        html += '<li>Huk av om du ønsker at siste side skal inneholde tegnforklaring.</li>';
        html += '<li>Klikk på «Lag kartet!»</li>';
        html += '<li>Vent til kartet er ferdig, klikk på last ned, og skriv ut pdf’en.</li>';
        html += '</ol>';
        html += '<h4>Hva betyr målestokken?</h4>';
        html += '<ul>';
        html += '<li>1:25 000 betyr at 1 meter på kartet er 25 km i virkeligheten, dvs. 1 cm = 250 m</li>';
        html += '<li>1:50 000 betyr at 1 meter på kartet er 50 km i virkeligheten, dvs. 1 cm = 500 m</li>';
        html += '</ul>';
