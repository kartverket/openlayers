...
OpenLayers.Control.Help = OpenLayers.Class(OpenLayers.Control, {
  ...
  showControls: function () {
    ...
    html += '<div class="shortcuts-panel"><p></p>';
    ...
    html += '</div><p></p>';
    html += '<table><thead><tr><th scope="col">' + OpenLayers.Lang.translate('Keyboard shortcut') + '</th><th scope="col">' + OpenLayers.Lang.translate('Function') + '</th></tr></thead><tbody>';
    ...
    html += '</div>';
    html += '<div id="legend" class="help-menu">';
    html += '<h1 class="h">Tegnforklaring</h1>';
    //html += '<div id="legendBox" class="legend-panel" style="">Ingen tegnforklaring';
    html += '<img src="img/tegnforklaring_v4.png" alt="tegnforklaring" height=670 width=400 style="background-color:white;" />';
    html += '</div>';
    html += '</div>';
    //html += '<div id="howto" class="help-menu"></div>';
    //html += '<div id="about" class="help-menu"></div>';
    this.cnt.innerHTML = html;

    $(".help-menu").children("div").hide();
