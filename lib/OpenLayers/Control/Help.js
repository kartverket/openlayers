...
OpenLayers.Control.Help = OpenLayers.Class( OpenLayers.Control, {
    ...
    showControls: function () {
        ...
        html += '<tr><td>F11</td><td>'+OpenLayers.Lang.translate('Full screen')+'</td></tr>';
        html += '<tr><td>' + ctrlKey + 'P</td><td>'+ OpenLayers.Lang.translate('Print')+'</td></tr>';
        html += '<tr><td>+ og -</td><td>'+ OpenLayers.Lang.translate('Zoom')+'</td></tr>';
        html += '<tr><td>'+ OpenLayers.Lang.translate('Arrow keys')+'</td><td>'+ OpenLayers.Lang.translate('Pan')+'</td></tr>';
        html += '<tr><td>Home, End, PageUp, PageDown</td><td>'+  OpenLayers.Lang.translate('Fast panning')+'</td></tr>';
