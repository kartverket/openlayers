...
//        size = new OpenLayers.Size( 230, 58);
        ...
        /* code for mobile/tablet version button - to be reactivated
        ...
        btn.innerHTML = OpenLayers.Util.hideFromOldIE(this.buttonIcon) + '<span>' + OpenLayers.Lang.translate('Search') + '</span>';
