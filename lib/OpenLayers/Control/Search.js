        ...
        */
                ...
                request.done(function(response){
                    ...
                    if (parsedResponse && parsedResponse.length > 0) {
                      ...
                      for (i = 0; i < parsedResponse.length; i++) {
                        ...
                        if (!r['LONGITUDE']) continue; // TODO: Error message - property has no known geometries 
        ...
        if (params) {
            if (typeof params.phrase === 'string') {
                ...
                if ( resultsList.length === 0 ) { //TODO: put this into utility function
                ...
                if (inputEPSG != "4326") {
                  ...
                  resultsList.html( $('<div/>', {'id':'projectionNotice', html: 'Koordinatene tolkes som <a href="http://epsg.io/' + inputEPSG + '" target="_blank" style="color:#fff">' + inputName + "</a>.<br />Bytt projeksjon til "}) );
                  var noticeElement = document.getElementById("projectionNotice");
                  if (!!noticeElement) {
                ...
                resultsList.html( $('<div/>', {'id':'propertySearchNotice', html: 'S&oslash;k etter eiendommer som f&oslash;lgt:<br/>Kommune-G&aring;rdsnr/Bruksnr/Feste/Seksjon<br/>f.eks.: <b>Ringerike-38/98</b></br/>eller ved &aring; taste inn gateadressen.'}) );
                document.getElementById('propertySearchNotice').setAttribute("class","result-category");
                document.getElementById('propertySearchNotice').setAttribute("style","text-transform:none; font-size:small;");
                resultsList.show();
