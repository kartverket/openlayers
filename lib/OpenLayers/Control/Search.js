        ...
        */
        ...
        if (params) {
            if (typeof params.phrase === 'string') {
                ...
                resultsList.html( $('<div/>', {'id':'propertySearchNotice', html: 's&oslash;k etter eiendommer som f&oslash;lgt:<br/><b>Kommune - G&Aring;rdsNR / BruksNR / FesteNR / SeksjonsNR</b><br/>f.eks.: Ringerike-38/98</br/>eller ved &aring; taste inn gateadressen'}) );
                resultsList.show();
