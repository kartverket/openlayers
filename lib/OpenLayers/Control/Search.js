            ...
            places.each(function(){
                ...
                switch(place.type) {
                    ...
                    case 'Bruk (gardsbruk)':
                        ...
                        break;
                    default:
// place.name + ', ' + place.type + ' <span class="municipality-name">' + place.municipality + '</span>
                        placeElement = getPlaceElement(place, 8, municipalityFn);
                        objectsListElement.append(placeElement);
                        objectsCount += 1;
                } // switch
        ...
        $('#searchResults a.close').on( "click", function(e){ $('#searchResults').remove(); return false; });
    ...
    addMarkers: function (places) {
        ...
        markerLayer = this.getMarkerLayer();
