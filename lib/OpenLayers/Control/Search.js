        ...
        */
        ...
        if (params) {
	        ...
	        var trf = map.getControlsByClass("OpenLayers.Control.Transformations")[0];
                ...
                var fromProjCode = (""+fromProj).split(":")[1];
                var resultsList = $('#searchResults');
                resultsList.html( $('<div/>', {'id':'projectionNotice', html: 'Koordinatene tolkes i projeksjon <a href="http://epsg.io/' + fromProjCode + '">' + inputName + "</a>. Bytt projeksjon til [v][dropdown menu]."}) );
                resultsList.show();
