            ...
            if (!!json){
              $.each(json, function(){
                ...
                var coords = new OpenLayers.LonLat(parseFloat(this['LONGITUDE']), parseFloat(this['LATITUDE']));
                  ...
                  placeElement.attr("data-zoom",  13);
            ...
            xmlPlaces.each(function(){
                ...
                switch(place.type) {
                    ...
                    case 'Fylke':
                        ...
                        break;
                    case 'Kommune':
                        placeElement = getPlaceElement(place, 13, countyFn);
                        areasListElement.append(placeElement);
                        areasCount += 1;
                        break;
                    case 'By':
                    ...
                    case 'Bygdelag (bygd)':
                    case 'Tettsteddel':
                        placeElement = getPlaceElement(place, 13, municipalityFn);
                        areasListElement.append(placeElement);
                        areasCount += 1;
                        break;
