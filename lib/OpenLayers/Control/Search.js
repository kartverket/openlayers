...
OpenLayers.Control.Search = OpenLayers.Class(OpenLayers.Control, {
    ...
    searchIcon: '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 34 35" style="enable-background:new 0 0 34 35;" xml:space="preserve"><g><g><path class="st0" d="M23.6,22.8c2.2-2.4,3.6-5.7,3.6-9.2C27.2,6.1,21.1,0,13.6,0C6.1,0,0,6.1,0,13.6c0,7.5,6.1,13.6,13.6,13.6    c3.1,0,5.9-1,8.1-2.7l10.1,10.1c0.2,0.2,0.6,0.4,0.9,0.4c0.3,0,0.6-0.1,0.9-0.4c0.5-0.5,0.5-1.3,0-1.7L23.6,22.8z M2.5,13.6    c0-6.1,5-11.1,11.1-11.1c6.1,0,11.1,5,11.1,11.1s-5,11.1-11.1,11.1S2.5,19.7,2.5,13.6L2.5,13.6z"/></g></g></svg>',
    ...
    initialize: function(options) {
        ...
        this.title = OpenLayers.Lang.translate('Search').replace('&oslash;', 'ø');
    ...
    draw: function () {
        var inputElem,
            ...
            formElem,
            btn,
            classNames = 'activate-search nkButton';
        
        btn = OpenLayers.Util.createButton( 'button-activate-search-' + self.map.id, null, null, null, 'static');
        btn.title = this.title;
        OpenLayers.Element.addClass(btn, classNames);
        btn.innerHTML = OpenLayers.Util.hideFromOldIE(this.buttonIcon);
        OpenLayers.Event.observe(btn, 'click', OpenLayers.Function.bind(this.toggleWidget, this));
        ...
        inputElem.setAttribute('placeholder', OpenLayers.Lang.translate('Find place, coordinates, address'));
        ...
        submitBtn.innerHTML = this.searchIcon;//OpenLayers.Lang.translate('Search');
    ...
    hideControls: function () {
        ...
        console.log(map);
        var layers = map.getLayersByName('searchResultMarkers');
        if (layers.length) {
    ...
    trf: function() {
       if (!this.transformations) {
         this.transformations = map.getControlsByClass("OpenLayers.Control.Transformations")[0];
       }
        ...
        */
                ...
                request.done(function(response){
                    ...
                    if (parsedResponse && parsedResponse.length > 0) {
                      ...
                      for (i = 0; i < parsedResponse.length; i++) {
                        ...
                        if (!r['LONGITUDE']) {
                          that.displaySearchNotice(OpenLayers.lang.translate('Search results contain properties without known borders. We cannot display these, but you can repeat your search on <a href="http://www.seeiendom.no" target="_blank" style="color:#fff">seeiendom.no</a> to retrieve more information.'));
        ...
        if (params) {
            if (typeof params.phrase === 'string') {
                ...
                this.displaySearchNotice(OpenLayers.Lang.translate('Search for properties as follows:<br/>Municipality-Gardsnr/Bruksnr/Feste/Seksjon<br/>e.g.: <b>Ringerike-38/98</b></br/> or by entering an address.'));
    ...
    drawResponse: function() {
        ...
        if (xmlPlaces.length === 0 && json === null) {
            ...
            */
            ...
            areasElement.append($('<h2 class="h">'+OpenLayers.Lang.translate('Areas')+'</h2>'));
            areasListElement = $('<ul/>');
            ...
            addressesElement.append($('<h2 class="h">'+OpenLayers.Lang.translate('Addresses')+'</h2><ul>'));
            ...
            objectsElement.append($('<h2 class="h">'+OpenLayers.Lang.translate('Objects')+'</h2><ul>'));
            ...
            xmlPlaces.each(function(){
                ...
                var i18nPlace = function(type) {
                  ...
                  if (!!no2en[type]) {
                    return OpenLayers.Lang.translate(no2en[type]);
                  }
                  return type;
                }
...
//            popup.keepInMap = true;
	...
	if ( ! center ) return;
        if ( ! OpenLayers.Control.PointMenu ) return;
