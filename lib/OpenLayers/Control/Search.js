        ...
        if (params) {
            if (typeof params.phrase === 'string') {
                ...
                if (inputEPSG != "4326") {
                  ...
                  resultsList.html( $('<div/>', {'id':'projectionNotice', html: 'Koordinatene tolkes som <a href="http://epsg.io/' + inputEPSG + '" style="color:#fff">' + inputName + "</a>.<br />Bytt projeksjon til "}) );
