            ...
            places.each(function(){
                ...
                switch(place.type) {
                    ...
                    case 'Adressenavn (veg/gate)':
                        zoomLevel = 12;
                        listItem = '<li class="search-place" data-east="' + place.east + '" data-north="' + place.north + '" data-zoom="' + zoomLevel + '">' + place.name + ', <span class="municipality-name">' + place.municipality + '</span></li>';
