...
OpenLayers.Control.Search = OpenLayers.Class(OpenLayers.Control, {
    ...
    draw: function () {
        ...
        keyboardBtn.innerHTML = '<img src="theme/norgeskart/img/keyboard.png" width="19" height="13" alt="keyboard">';

        OpenLayers.Event.observe(keyboardBtn, 'click',
          OpenLayers.Function.bind(this.toggleKeyboard, this)
        );

        formElem.appendChild(inputResultsPerPage);
        formElem.appendChild(inputResultPageNumber);
        formElem.appendChild(inputElem);
        formElem.appendChild(keyboardBtn);
        ...
        $.extend($.keyboard.keyaction, {
            no: function (base) {
                ...
                base.position.at2 = 'right bottom';
