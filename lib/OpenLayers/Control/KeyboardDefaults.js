...
OpenLayers.Control.KeyboardDefaults = OpenLayers.Class(OpenLayers.Control, {
    ...
    defaultKeyPress: function (evt) {
        ...
        switch (evt.keyCode) {
            ...
            case 8:  //backspace, undo last drawing
    	    case 46: //delete, undo last drawing
                drawCtrls = this.map.getControlsByClass("OpenLayers.Control.Draw");
                if (drawCtrls) {
                  drawCtrls[0].tools.handlers.undo();
                }
                break;
