...
OpenLayers.Control.FullScreen = 
    ...
    controlsToHideClass:  'olControlNoSelect',
    ...
    draw: function () {
        ...
        imgLocation = OpenLayers.Util.getImageLocation("fullscreen.png");
    ...
    hideControls: function () {
        $("." + this.controlsToHideClass).not("." + this.panelClass).hide();
    }, //hideControls


    showControls: function () {
        $("." + this.controlsToHideClass).show();
    }, // showControls
