...
OpenLayers.Control.OverviewMapExpandable = OpenLayers.Class(OpenLayers.Control.OverviewMap, {
  expandSvg: '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" class="icon expand"><path fill="transparent" stroke="#333" stroke-width="2" d="M1 0v23h22v-22h-22M18 18l-11 -11M16 7h-9v9" /></svg>',
  minimizeSvg: '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" class="icon minimize"><path fill="transparent" stroke="#333" stroke-width="2" d="M1 0v23h22v-22h-22M6 6l11 11M17 8v9h-9" /></svg>',
  configuration: {
    'default': {
      size: {
        w: 80,
