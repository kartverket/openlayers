...
OpenLayers.Control.Transformations =
    ...
    generateCoordinateSystemsList: function (id, label, selectedValue, viewableOnly, fromOnly) {
        ...
        elements.select.setAttribute('class', 'form-control input-sm');
    ...
    insertContent: function (coordinate) {
        ...
        eastInput.setAttribute('class', 'form-control input-sm');
        ...
        northInput.setAttribute('class', 'form-control input-sm');
        ...
        outputWrapper.setAttribute('id', 'transformations-output');
        this.inputForm.appendChild(outputWrapper);
    ...
    transform: function (event, ignorDisabling ) {
        ...
        if (requestParams.ost && requestParams.nord) {
            this.transformData(requestParams, this.standardOut);
        } else {
            // throw error
            var transformationsOutput = document.getElementById('transformations-output');
            if (transformationsOutput !== null) {
                transformationsOutput.innerHTML = '<img alt="!" src="theme/norgeskart/img/warning.png">' + OpenLayers.Lang.translate('Wrong coordinate input');
            }
        }
