...
OpenLayers.Control.Transformations = 
    ...
    initialize: function(options) {
        ...
        this.sosiCodes = [
            ...
            {'ESRI': null, 'EPSG': null, 'SOSI': 9, 'name': 'NGO1948, datum NGO1948, Geografisk Ingen projeksjon, enhet:sekunder'},
            {'ESRI': 32631, 'EPSG': 32631, 'SOSI': 21, 'name': 'UTM sone 31 basert på EUREF89/WGS84'},
            {'ESRI': 32632, 'EPSG': 32632, 'SOSI': 22, 'name': 'UTM sone 32 basert på EUREF89/WGS84'},
            {'ESRI': 32633, 'EPSG': 32633, 'SOSI': 23, 'name': 'UTM sone 33 basert på EUREF89/WGS84'},
            {'ESRI': 32634, 'EPSG': 32634, 'SOSI': 24, 'name': 'UTM sone 34 basert på EUREF89/WGS84'},
            {'ESRI': 32635, 'EPSG': 32635, 'SOSI': 25, 'name': 'UTM sone 35 basert på EUREF89/WGS84'},
            {'ESRI': 32636, 'EPSG': 32636, 'SOSI': 26, 'name': 'UTM sone 36 basert på EUREF89/WGS84'},
            {'ESRI': 23031, 'EPSG': 23031, 'SOSI': 31, 'name': 'UTM sone 31 basert på ED50'},
            {'ESRI': 23032, 'EPSG': 23032, 'SOSI': 32, 'name': 'UTM sone 32 basert på ED50'},
            {'ESRI': 23033, 'EPSG': 23033, 'SOSI': 33, 'name': 'UTM sone 33 basert på ED50'},
            {'ESRI': 23034, 'EPSG': 23034, 'SOSI': 34, 'name': 'UTM sone 34 basert på ED50'},
            {'ESRI': 23035, 'EPSG': 23035, 'SOSI': 35, 'name': 'UTM sone 35 basert på ED50'},
            {'ESRI': 23036, 'EPSG': 23036, 'SOSI': 36, 'name': 'UTM sone 36 basert på ED50'},
            {'ESRI': null, 'EPSG': null, 'SOSI': 41, 'name': 'Lokalt nett, uspesifisert'},
            {'ESRI': null, 'EPSG': null, 'SOSI': 42, 'name': 'Lokalt nett, uspesifisert'},
            {'ESRI': null, 'EPSG': null, 'SOSI': 50, 'name': 'ED 50 Geografisk, ingen projeksjon, enhet:sekunder'},
            {'ESRI': null, 'EPSG': null, 'SOSI': 51, 'name': 'NGO-56A basert på NGO1948.Benyttet for Møre'},
            {'ESRI': null, 'EPSG': null, 'SOSI': 52, 'name': 'NGO-56B basert på NGO1948.Benyttet for Møre'},
            {'ESRI': null, 'EPSG': null, 'SOSI': 53, 'name': 'NGO-64A basert på NGO1948.Benyttet for Møre'},
            {'ESRI': null, 'EPSG': null, 'SOSI': 54, 'name': 'NGO-64B basert på NGO1948.Benyttet for Møre'},
            {'ESRI': null, 'EPSG': null, 'SOSI': 72, 'name': 'WGS72 Geografisk, ingen projeksjon,enhet:sekunder'},
            {'ESRI': null, 'EPSG': null, 'SOSI': 84, 'name': 'EUREF89/WGS84 Geografisk Ingen projeksjon,enhet:sekunder'},
            {'ESRI': null, 'EPSG': null, 'SOSI': 87, 'name': 'ED 87 Geografisk Ingen projeksjon,enhet:sekunder'},
            {'ESRI': null, 'EPSG': null, 'SOSI': 99, 'name': 'Egendefinert.Benytter TRANSSYS for å angi transformasjonsparametre fra lokalt over til et kjent koordinatsystem'},
            {'ESRI': null, 'EPSG': null, 'SOSI': 101, 'name': 'Lokalt nett, Oslo'},
            {'ESRI': null, 'EPSG': null, 'SOSI': 102, 'name': 'Lokalt nett, Bærum'},
            {'ESRI': null, 'EPSG': null, 'SOSI': 103, 'name': 'Lokalt nett, Asker'},
            {'ESRI': null, 'EPSG': null, 'SOSI': 104, 'name': 'Lokalt nett, Lillehammer'},
            {'ESRI': null, 'EPSG': null, 'SOSI': 105, 'name': 'Lokalt nett, Drammen'},
            {'ESRI': null, 'EPSG': null, 'SOSI': 106, 'name': 'Lokalt nett, Bergen/Askøy'},
            {'ESRI': null, 'EPSG': null, 'SOSI': 107, 'name': 'Lokalt nett, Trondheim'},
            {'ESRI': null, 'EPSG': null, 'SOSI': 108, 'name': 'Lokalt nett, Bodø'},
            {'ESRI': null, 'EPSG': null, 'SOSI': 109, 'name': 'Lokalt nett, Kristiansund'},
            {'ESRI': 4230, 'EPSG': 4230, 'SOSI': 4230, 'name': 'ED 50 Geografisk, ingen projeksjon, enhet:grader'},
            {'ESRI': 4231, 'EPSG': null, 'SOSI': 4231, 'name': 'ED 87 Geografisk Ingen projeksjon ,enhet:grader'},
            {'ESRI': 4273, 'EPSG': 4273, 'SOSI': 4273, 'name': 'NGO1948 , datum NGO1948, Geografisk Ingen projeksjon, enhet:grader'},
            {'ESRI': null, 'EPSG': 4322, 'SOSI': 4322, 'name': 'WGS72 Geografisk, ingen projeksjon,enhet:grader'},
            {'ESRI': 4326, 'EPSG': 4326, 'SOSI': 4326, 'name': 'EUREF89/WGS84 Geografisk Ingen projeksjon, enhet:grader'}
        ];
    }, // initialize
