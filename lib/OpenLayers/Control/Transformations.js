...
OpenLayers.Control.Transformations =
    ...
    setCoordinateCookie : function (sel) {
      var proj = sel.value;
    ...
    generateCoordinateSystemsList: function (id, label, selectedValue) {
        ...
        elements.select.setAttribute('onchange', "map.getControlsByClass('OpenLayers.Control.Transformations')[0].setCoordinateCookie(this)");
        return elements;
    },
