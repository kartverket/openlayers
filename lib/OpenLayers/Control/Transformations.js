...
OpenLayers.Control.Transformations = 
    ...
    showControls: function () {
        ...
        html += '<p>' + OpenLayers.Lang.translate('Fill out the coordinate fields or click in the map') + '</p>';
        html += '<label for="transformations-east-coordinate">' + OpenLayers.Lang.translate('East coordinate') + '</label>';
        html += '<input id="transformations-east-coordinate" type="text" />'
        html += '<label for="transformations-north-coordinate">' + OpenLayers.Lang.translate('North coordinate') + '</label>';
        html += '<input id="transformations-north-coordinate" type="text" />'
        ...
        html += '<button type="submit">' + OpenLayers.Lang.translate('Show coordinates') + '</button>';
