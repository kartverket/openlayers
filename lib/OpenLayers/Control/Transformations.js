...
OpenLayers.Control.Transformations = 
    ...
    showControls: function () {
        ...
        inSystem = generateCoordinateSystemsList('transformations-input-coordinate-system', OpenLayers.Lang.translate('Select input coordinate system'), 23);
        ...
        eastLabel.innerHTML = '<label for="transformations-east-coordinate">' + OpenLayers.Lang.translate('East coordinate') + '</label>';
        ...
        northLabel.innerHTML = '<label for="transformations-north-coordinate">' + OpenLayers.Lang.translate('North coordinate') + '</label>';
        ...
        outSystem = generateCoordinateSystemsList('transformations-output-coordinate-system', OpenLayers.Lang.translate('Select output coordinate system'), 23);
