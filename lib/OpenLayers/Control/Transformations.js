...
OpenLayers.Control.Transformations =
    ...
    initialize: function(options) {
        ...
        OpenLayers.Util.extend(OpenLayers.Lang.nb, {
            ...
            'Help': 'Hjelp',
            'East coordinate': 'Øst-koordinat',
            'North coordinate': 'Nord-koordinat',
        ...
        this.sosiCodes = [
            {'ESRI': null, 'EPSG': 4326, 'SOSI': 84, 'name': 'EU89 - Geografisk, grader', 'viewable': false}, //viewable, but not necessary in selectors
    ...
    draw: function () {
        ...
        btn.innerHTML = OpenLayers.Util.hideFromOldIE('<svg class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 20 20" enable-background="new 0 0 20 20" xml:space="preserve"><g><path d="M8.3,17.5l-2.3-5.1l-2.3,5.1H0.4l4.1-7.8 L0.9,2.9h3.2l1.8,3.9l1.8-3.9h3.1L7.4,9.5l4,8H8.3z"/></g><g><path d="M15.5,11.5v6h-2.7v-6l-4-8.6h3.1l1.7,4 c0.3,0.8,0.5,1.3,0.7,1.9c0.2-0.4,0.4-1.1,0.7-1.8l1.7-4h3.1L15.5,11.5z"/></g></svg>');
        ...
        if (self.div == null) {
            ...
            if (OpenLayers.Element.hasClass(self.div, 'panel')) {
                ...
                toolElement.id = 'transformations-panel';
    ...
    generateCoordinateSystemsList: function (id, label, selectedValue, viewableOnly) {
        ...
        elements.label.setAttribute('class', 'lbl');
    ...
    insertContent: function (coordinate) {
        ...
        fieldset.setAttribute('class', 'fld');
        ...
        eastLabel.setAttribute('class', 'lbl');
        ...
        northLabel.setAttribute('class', 'lbl');
        ...
        this.buttonWrapper.setAttribute('class', 'buttonWrapper buttons-panel');
    ...
    standardOut: function (result, status, request) {
        ...
        if (result.hasOwnProperty('errKode') && result.errKode !== 0) {
            ...
            if ((result.sosiKoordSys == 84) || (result.sosiKoordSys == 50)) {
