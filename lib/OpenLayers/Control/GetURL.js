...
OpenLayers.Control.GetURL = 
    ...
    showControls: function () {
    	this.cnt.innerHTML = '<span>' + OpenLayers.Lang.translate('Copy the following address to share this page', 'nb') +  '</span><div class="page-url">' + window.location.href + '</div>';
