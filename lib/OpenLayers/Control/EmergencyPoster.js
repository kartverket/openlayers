  ...
  main: null,
    ...
    */
    ...
    drawPreviewPopup: function(){
      ...
      md  = self.getMDfromDMS(dms);
      mgrs = self.getMGRSfromCoords();
    ...
    */
    ...
    previewPrintHandler: function(){
      ...
      epWindow.document.write('<html><head><title>Print it!</title><link rel="stylesheet" type="text/css" href="theme/norgeskart/style.css">' +
