  ...
  initialize: function(options) {
    ...
    */
    ...
    goToAdress: function() {
      ...
      request.done(function(data){
        ...
        for(i = 0, j = markers.length; i < j; i += 1) {
          var point = new OpenLayers.Geometry.Point(markers[i].east, markers[i].north);
        ...
        that.map.setCenter(features[0].data.lonlat, zoom);
    ...
    streetsListObserver: function(evt){
      ...
      var newValue = streets.selectedIndex;
