                        ...
                        '<div class="location-details-header">'+
                            ...
                            '<img src="theme/norgeskart/img/KV_nodplakat_2.png" alt="2."><p>' +OpenLayers.Lang.translate('My location is');
                                if(!!self.matrikkelInfo.veg){
                                  tmpText += '</br>'+title+' og veien er: ' + self.matrikkelInfo.veg +'</p>';
                                } else {
                                  tmpText += '</br>'+title+'</p>';
                                }
                                tmpText += '<img src="theme/norgeskart/img/KV_nodplakat_3.png" alt="3."><p>' + OpenLayers.Lang.translate('My matrikel is');
