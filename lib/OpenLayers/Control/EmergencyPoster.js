  ...
  main: null,
    ...
    initialize: function(options) {
        ...
        OpenLayers.Util.extend(OpenLayers.Lang.nb, {
            ...
            'My UTM location' : 'Min UTM-posisjon er:',
            'in' : 'i',
            'degrees' : 'grader',
            'minutes' : 'minutter',
            'seconds' : 'sekunder',
        ...
        var tmpText = '<div class="header">'+
            ...
            '<div class="preview-container">'+
                '<div class="preview emergencyKV" id="emergencyPrint">'+
                    '<div class="header"><img src="theme/norgeskart/img/KV_nodplakat_header.png" alt="Nodplakat">';
                    ...
                    '<div class="location-details-wrapper">'+
                        '<div class="location-details-header">'+
                            ...
                            '</p>'+
                            //'<p>'+OpenLayers.Lang.translate('My street is')+ '</p>' +
                            '<img src="theme/norgeskart/img/KV_nodplakat_2.png" alt="2."><p>' +OpenLayers.Lang.translate('My location is')+
                                '</br>'+title+'</p>' +
                            '<img src="theme/norgeskart/img/KV_nodplakat_3.png" alt="3."><p>' + OpenLayers.Lang.translate('My matrikel is')
                                if(!!self.matrikkelInfo){
                                    tmpText += '</br>' + self.matrikkelInfo;
                                } else {
                                    tmpText += '</br>' + '</br>';
                                }
                            tmpText += '</p>'+
                            '<img src="theme/norgeskart/img/KV_nodplakat_4.png" alt="4."><p>' + OpenLayers.Lang.translate('My UTM location') +
                                '</br>Sone33 '+(~~self.coordinates.lon)+' '+(~~self.coordinates.lat)+
                            '</p>'+
                        '</div>'+
    ...
    */
    ...
    previewPrintHandler: function(){
        ...
        epWindow.document.write('<html><head><title>Print it!</title><link rel="stylesheet" type="text/css" href="theme/norgeskart/style.css"><link rel="stylesheet" media="print" type="text/css" href="theme/norgeskart/print.css"></head><body>');
    ...
    getMatrikkelInfo : function (bbox) {
      ...
      // Then retrieve locations from within bounding box
      $.ajax({
        url: self.matrikkelInfoURL,
        type: 'GET',
        data: bbox,
        crossDomain: true,
        context: this,
        success: function(response, statusText){
            self.matrikkelInfo = response;
        },
        error: function(jqXHR, textStatus, errorThrown){
          console.log('error: ' + textStatus + ' : ' + errorThrown);
        }
