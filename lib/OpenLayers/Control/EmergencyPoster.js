                ...
                '<div class="preview emergencyKV" id="emergencyPrint">'+
                    ...
                    '<div class="location-details-wrapper">'+
                        '<div class="location-details-header">'+
                            '<p>' + OpenLayers.Lang.translate('My position is')+
                                '</br>'+
                            ...
                            '<p>' +OpenLayers.Lang.translate('My location is')+
                                '</br>'+title+'</p>' +
                            '<p>' + OpenLayers.Lang.translate('My matrikel is')
                            ...
                            tmpText += '</p>'+
                            '<p>' + OpenLayers.Lang.translate('My UTM location') +
