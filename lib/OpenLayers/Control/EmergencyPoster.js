...
OpenLayers.Control.EmergencyPoster = OpenLayers.Class(OpenLayers.Control.Panel, {
	...
	/*
	var self = this, widget = self.termsWidget; 
	var url  = self.getServicURL();
	var html = url ? '<iframe src="'+url+'" ></iframe>' :
	    '<div class="error">Missing serivce url.</div>';
    ...
    */
    ...
    _kiet : function ( text, value ) {
        ...
        if ( ! debug ) {
	    var style = 'position:fixed;right:10px;bottom:10px;'+
		'height:150px;width:300px;overflow:scroll;'+
		'background-color:white;color:black;z-index:10000;font-size:11px';
