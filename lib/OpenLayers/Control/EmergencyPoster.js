...
OpenLayers.Control.EmergencyPoster = OpenLayers.Class(OpenLayers.Control.Panel, {
    ...
    drawLocationPopup: function (container) {
        ...
        self.locationRedoButton.innerHTML = "Velg nytt sted";
        ...
        self.locationAcceptButton.innerHTML = "Godkjenn og klargjør utskrift";
    ...
    drawTermsPopup: function ( container ) {
        ...
        self.termsWidget.innerHTML =
            ...
            '</div>'+
            '<div class="step-body">' +
                '<h2 class="h">Ansvar</h2>'+
                '<p>'+
                    'Nødplakaten er utviklet i samarbeid med Hovedredningsentralene '+
                    'og nødetatene. Kartverket er ansvarlig for datagrunnlaget, dvs. '+
                    'stedsnavn og kart - samt teknologien bak.'+
                '</p>'+
                '<p>'+ 
                    'Det er brukerens ansvar å kontrollere at det er korrekt hytte '+
                    'eller sted som vises på plakaten.'+
                '</p>'+
                '<p>'+
                    'Kartverket tar ikke ansvar for mulige feil som skyldes brukeren, '+
                    'datagrunnlaget eller teknologien.'+
                '</p>'+
            '</div>';
        ...
        self.termsAcceptButton.innerHTML = "Jeg godtar og går videre";

        //OpenLayers.Event.observe(self.termsAcceptButton, 'click', self.termsButtonObserver, true);
