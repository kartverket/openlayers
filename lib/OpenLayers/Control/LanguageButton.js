...
OpenLayers.Control.LanguageButton = 
    ...
    initialize: function(options) {
        ...
        OpenLayers.Util.extend(OpenLayers.Lang.nb, {
            'Norsk bokm&aring;l': 'English'
        });
        
        this.title = OpenLayers.Lang.translate('Norsk bokm&aring;l');
    }, // initialize
    
    draw: function () {
        var self   = this, cName = 'Lang-button nkButton';
	    var mapped = 'OpenLayers_Control_LanguageButton' + self.map.id;
        var btn    = OpenLayers.Util.createButton( mapped, null, null, null, 'static');
                    
        OpenLayers.Event.observe(btn, 'click', 
            OpenLayers.Function.bind( self.toggleLanguage, self )
        );
        
        btn.id = 'language-button';
        ...
        btn.innerHTML="<span>"+self.title+"</span>";
        ...
        OpenLayers.Element.addClass(self.widget, "hidden");
    ...
    showControls: function () {
        var html = '<h1 class="h">' + OpenLayers.Lang.translate('Norsk') + '</h1>';
    ...
    CLASS_NAME: "OpenLayers.Control.LanguageButton"
