...
OpenLayers.Control.Info = OpenLayers.Class( OpenLayers.Control, {
    ...
    showControls: function () {
      ...
      html += '<p>Vel temakart i menyen til venstre under «Fagdata» for å sjå ulike temakart og informasjon om stadnamn. Klikk på kvart stadnamn for å få meir informasjon om namnet.</p>';
