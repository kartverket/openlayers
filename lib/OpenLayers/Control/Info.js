...
OpenLayers.Control.Info = OpenLayers.Class( OpenLayers.Control, {
    ...
    showControls: function () {
      ...
      html += '<tr><td>Piltastar</td><td>Panorera</td></tr>';
      html += '<tr><td>Home, End, PageUp, PageDown</td><td>Panorera raskt</td></tr>';
      html += '</tbody></table>';
      html += '</div>';

      html += '<h5 class="h">Om stadnamn i norgeskart.no</h5>';
      html += '<div id="infoBox" class="infoBox-panel">';
      html += '<p>Kartløysinga viser stadnamn som ligg i <a href="http://www.kartverket.no/Kart/Stedsnavn/Sentralt-stadnamnregister-SSR/">Sentralt stadnamnregister (SSR)</a>.</p>';
      html += '<p>Vel temakart i menyen til høgre under «Fagdata» for å sjå ulike temakart og informasjon om stadnamn. Klikk på kvart stadnamn for å få meir informasjon om namnet.</p>';
      html += '<p><a href="http://kartverket.no/kart/stedsnavn/sentralt-stadnamnregister-ssr/saksbehandlingsstatus-for-skrivematen/">Gå til kartverket.no for å lesa meir om status for skrivemåten av stadnamn.</a></p>';
      html += '</div>';
