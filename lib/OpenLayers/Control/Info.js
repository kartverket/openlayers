...
OpenLayers.Control.Info = OpenLayers.Class( OpenLayers.Control, {
    ...
    showControls: function () {
      ...
      html += '<h5 class="h">Om tilgjengelighet i norgeskart.no</h5>';
      html += '<div id="infoBox" class="infoBox-panel">';
      html += '<p>Kartløsningen viser grad av tilgjengelighet i tettsteder og friluftsområder. </p>';
      html += '<p>Velg temakart i menyen til høyre under Fagdata for å vise tilgjengelighet etter ulike kriterier. Klikk på det enkelte objekt for å få mer informasjon om objektets tilgjengelighet.</p>';
      html += '<p>Gå til <a href="http://www.kartverket.no/tilgjengelighet/">kartverket.no/tilgjengelighet</a> for å lese mer om datasettet</p>';
      html += '</div>';

      html += '<h5 class="h">Tegnforklaring</h5>';
      //html += '<div id="legendBox" class="legend-panel" style="">Ingen tegnforklaring, velg f\u00f8rst et lag under TJENESTER.';
      html += '<img src="theme/norgeskart/img/Tegnforklaring kartsymboler_v5-1.png" alt="tegnforklaring" height=670 width=400 style="background-color:white;" />';
      html += '</div>';
