...
OpenLayers.Control.Info = OpenLayers.Class( OpenLayers.Control, {
    ...
    showControls: function () {
      ...
      html += '<h5 class="h">Om Norgeskart</h5>';
      html += '<div id="infoBox" class="infoBox-panel">';
      html += '<p>Nyttig info om Norgeskart kan du finne på <a href="http://www.kartverket.no/" onclick="window.location.href=this.href;">kartverket.no</a></p>';
      html += '</div>';
