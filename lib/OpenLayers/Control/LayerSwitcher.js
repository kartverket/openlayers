...
OpenLayers.Control.LayerSwitcher = OpenLayers.Class(OpenLayers.Control, {
  ...
  // DOM Elements
    ...
    redraw: function() {
        ...
        var treeDiv = $("#"+this.visibleDiv.id);
        treeDiv.fancytree({
          extensions: ["dnd"],
          source: [],
          minExpandLevel: 1,
          ...
          dnd: {
            ...
            dragDrop :  function(node, data) {
              ...
              //data.otherNode.moveTo(node, data.hitMode); no need to move, we redraw the tree. :P
            }
          }
        });
        
        var tree = treeDiv.fancytree("getTree").getRootNode();
        ...
        for(var i=0, len=layers.length; i<len; i++) {
            ...
            if (layer.displayInLayerSwitcher) {
                ...
                if (layer.getVisibility()) {
                  tree.addChildren({"title": layer.name, "tooltip":layer.url});
                } 
                ...
                labelSpan.style.verticalAlign = "text-bottom";
                labelSpan.style.paddingLeft = "3px";
                // create line break
