...
OpenLayers.Control.LayerSwitcher = OpenLayers.Class(OpenLayers.Control, {
  ...
  // DOM Elements
    ...
    loadContents: function() {
        ...
        this.visibleLbl.innerHTML = OpenLayers.Lang.translate("Chosen overlays");
        ...
        this.availableLbl.innerHTML = OpenLayers.Lang.translate("Service overlays");
        
        this.availableToggle = document.createElement('div');
        this.availableToggle.className = 'starred-layer-toggle';
        
        this.availableToggleLabel = document.createElement('i');
        this.availableToggleLabel.appendChild(document.createTextNode(OpenLayers.Lang.translate('Only show starred overlays')));
        
        this.availableToggleCheckbox = document.createElement('input');
        this.availableToggleCheckbox.setAttribute('id', 'compact-toggle');
        this.availableToggleCheckbox.setAttribute('type', 'checkbox');
        this.availableToggleCheckbox.setAttribute('value', '1');
        this.availableToggleCheckbox.checked = NK.compactMode ? true : false;
        
        this.availableToggle.appendChild(this.availableToggleLabel);
        this.availableToggle.appendChild(this.availableToggleCheckbox);
        ...
        this.layersDiv.appendChild(this.availableToggle);
        ...
        $('#compact-toggle').change(this, this.toggleStarredLayers);
    },
