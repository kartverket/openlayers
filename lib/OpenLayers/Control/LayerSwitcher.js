            ...
            if (layer.displayInLayerSwitcher) {
                ...
                if (!!parents && !!parents.length) {
                  ...
                  if (!service) {
                    ...
                    service = avlTree.addChildren({"title":layer.type.toUpperCase()+": "+layer.serviceTitle + " ("+layer.attribution.title.trunc(30)+")", "key":layer.url, 
                  ...
                  if (!!layer.parent) {
                    ...
                    var service = service.addChildren({"title":layer.parent, "key":layer.url, "tooltip":layer.url, "hideCheckbox": true, "unselectable": true, "expanded": expanded });
                  } 
