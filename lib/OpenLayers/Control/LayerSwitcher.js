    ...
    redraw: function() {
        ...
        for (var i=0; i <len; i++) {
            ...
            if (layer.isUrlDataLayer) {
              if (this.isInitialPass == true) {
                if (parent == null) {
                  if (NK.hasHashLayers == false) {
                    this.layerStates[i].visibility = true;
        ...
        for (var i = 0, j = layers.length; i < j; i++) {
          ...
          if (layer.isUrlDataLayer) {
            ...
            if (!li) {
              ...
              li.innerHTML = this.prettifyName(layer.title || layer.name);
