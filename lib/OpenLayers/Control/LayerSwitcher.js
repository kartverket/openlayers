    ...
    redraw: function() {
        ...
        for(var i=0, len=layers.length; i<len; i++) {
            ...
            if (layer.displayInLayerSwitcher) {
                layerData = {"title": layer.name, "tooltip":layer.url, "key":layer.id, "expanded": true };
                ...
                if (!!layer.parent) {
                  ...
                  if (!parent) {
                    parent = avlTree.addChildren({"title":layer.serviceTitle, "tooltip":layer.url, "hideCheckbox": true, "unselectable": true, "expanded": true })
                  }
