  ...
  // DOM Elements
    ...
    redraw: function() {
        ...
        for (var i = 0, j = layers.length; i < j; i++) {
          var layer = layers[i];
          if (layer.isUrlDataLayer) {
            var id = 'fg_layer_' + layer.name;
            var li = document.getElementById(id);
            if (!li) {
              li = document.createElement('li');
              li.classList.add('layer-list-item', 'layer-list-item-fg');
              li.id = id;
              ...
              li.innerHTML = layer.title;
              li.addEventListener('click', this.toggleLayerVisibility.bind(this, layer.name), false);
            ...
            if (!li) {
              li = document.createElement('li');
              li.classList.add('layer-list-item', 'layer-list-item-bg');
              li.id = id;
              li.innerHTML = OpenLayers.Lang.translate(layer.name);
     ...
     * e - {Event}
     */
    toggleLayerVisibility: function (name, e) {
      var layers = map.getLayersByName(name);
      if (layers) {
        var visibility = !layers[0].visibility;
        layers[0].isStarred = visibility;
    ...
    loadContents: function() {
        ...
        this.bgLabel = document.createElement('h2');
        ...
        this.fgLabel = document.createElement('h2');
