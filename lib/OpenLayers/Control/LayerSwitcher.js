...
OpenLayers.Control.LayerSwitcher = OpenLayers.Class(OpenLayers.Control, {
  ...
  // DOM Elements
        ...
        avlDiv.fancytree({
          ...
          renderColumns: function(event, data) {
            ...
            if (node.isTopLevel()) {
              ...
              info = '<button id="star-'+guid+'" title="' + OpenLayers.Lang.translate('Show in compact mode') + '"><svg class="icon star' + (selected ? ' selected' : '') + '" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 51 48"><path d="m25,1 6,17h18l-14,11 5,17-15-10-15,10 5-17-14-11h18z"/></svg></button>';
            }
    ...
    loadContents: function() {
        ...
        this.availableLbl.innerHTML = OpenLayers.Lang.translate("Available overlays")  + " - <button id='compact-toggle'>" + 
