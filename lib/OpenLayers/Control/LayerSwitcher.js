...
OpenLayers.Control.LayerSwitcher = OpenLayers.Class(OpenLayers.Control, {
  ...
  // DOM Elements
        ...
        var initLayerTree = function(div, reorder) { 
         div.fancytree({
          ...
          renderColumns: function(event, data) {
            ...
            tdList.eq(4).html("<span class='service-metadata' attribution-for='"+node.data.layerid+"'>("+OpenLayers.Lang.translate("about")+")</span>");
        ...
        for(var i=0, len=layers.length; i<len; i++) {
            ...
            if (!layer.isUrlDataLayer) {
              if (layer.getVisibility()) {
                var layerData = {"title": OpenLayers.Lang.translate(layer.name), "tooltip":layer.shortid, "key":layer.id };
    ...
    loadContents: function() {
        ...
        this.bgDiv.innerHTML = "<colgroup><col width='*'></col><col width='20px'></col><col width='50px'></col><col width='20px'></col><col width='50px'></col></colgroup>";
