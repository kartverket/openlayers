    ...
    steps: {
        ...
        area: {
            draw: function () {
                ...
                this.areaHandler = new OpenLayers.Handler.Box( this,
        ...
        preview: {
            draw: function () {
                ...
                elements.map.setAttribute('src', window.location.href);
                elements.map.setAttribute('width', '450px');
                elements.map.setAttribute('height', '350px');
