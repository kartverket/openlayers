...
OpenLayers.Control.Embed = 
    ...
    steps: {
        ...
        markers: {
            draw: function () {
                ...
                panel.appendChild(elements.heading);
                elements.explanation = document.createElement('p');
                elements.explanation.innerHTML = OpenLayers.Lang.translate('Click in the map to add markers with descriptions.');             
                panel.appendChild(elements.explanation);
    ...
    confirmAddedMarker: function (event) {
        var text;
        console.log('confirmAddedMarker');
        console.log(this.addedMarker);
