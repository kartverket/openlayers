...
OpenLayers.Control.Embed = 
    ...
    steps: {
        ...
        area: {
            draw: function () {
                ...
                this.areaHandler = new OpenLayers.Handler.ResizableBox( this,
                            {done: this.areaSelected}, {resizableBox: this.areaElement} );
                this.areaHandler.activate();
            },
            remove: function () {
                var panel = this.stepSpecificPanel;
                this.areaHandler.deactivate({keepBox: true});
        ...
        descriptions: {
            draw: function () {
                ...
                panel.appendChild(elements.shortDescWhy);
                ...
                panel.appendChild(elements.longDescWhy);
    ...
    areaSelected: function (position, areaElement, pixelBounds) {
        var center = position.getCenterLonLat();
        this.selectedAreaBounds = position;
