...
OpenLayers.Control.Embed = 
    ...
    embedMarkerPointSelectHandler: function (evt) {
        var feature, popup, label, input, okButton, cancelButton;
        if (this.selectedAreaBounds && this.selectedAreaBounds.containsLonLat(evt.lonLat)) {
            ...
            feature.popup.contentDiv.appendChild(input);
            cancelButton = document.createElement('button');
            cancelButton.innerHTML = 'avbryt';
            feature.popup.contentDiv.appendChild(cancelButton);
            okButton = document.createElement('button');
            okButton.innerHTML = 'fortsett';
            feature.popup.contentDiv.appendChild(okButton);
