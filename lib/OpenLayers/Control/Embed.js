...
OpenLayers.Control.Embed = 
    ...
    steps: {
        ...
        terms: {
            draw: function () {
                ...
                elements.p3.innerHTML = OpenLayers.Lang.translate('Content providers: Kartverket, Geovekst, municipalities and Norge digitalt partners.');
        ...
        descriptions: {
            draw: function () {
                ...
                elements.recommendation.innerHTML = OpenLayers.Lang.translate('To ensure a good user experience, we recommend you provide descriptions for your map. As a result, the embedded map will cater to people using assistive technology.');
        ...
        output: {
            draw: function () {
                ...
                elements.heading = document.createElement('h2');
                elements.heading.setAttribute('class', 'h');
                elements.heading.innerHTML = OpenLayers.Lang.translate('Select code and copy');
                panel.appendChild(elements.heading);
    ...
    /*
    adjustSelectedArea: function(){

        var self = this, points, tl, tr, bl, br;

        if (!self.attr['points']) return;

        points = self.attr['points'];
    ...
    */
    ...
    translateFeatureToMask: function(){
        ...
        self.attr['points'][1][0] = (tlp.x + width);
    ...
    */
    ...
    embedMarkerPointSelectHandler: function (evt) {
        var feature, 
            ...
            cancelButton,
            that = this,
            number = (this.data.markers) ? (this.data.markers.length + 1) : 1;
        ...
        feature = NK.functions.addLabeledMarker([evt.lonLat.lon, evt.lonLat.lat, number], number);
	...
	*/
    ...
    updatePoints: function(){
        ...
        console.log(center);
        self.data.centerX = parseInt(center.lon);
        self.data.centerY = parseInt(center.lat);
