...
OpenLayers.Control.Embed = 
    ...
    embedMarkerPointSelectHandler: function (evt) {
        ...
        feature = NK.functions.addLabeledMarker([evt.lonLat.lon, evt.lonLat.lat, ''], number);
    ...
    getURL: function () {
        ...
        if (hashLayers.length > 4 && hashLayers[3] === '-land') {
            hashLayers = hashLayers[3] + '/' + hashLayers[4] + '/';
        } else {
            hashLayers = '';
        }
