    ...
    steps: {
        ...
        descriptions: {
            draw: function () {
                ...
                elements.shortDescLabel.setAttribute('class', 'lbl');
                ...
                elements.shortDescInput.setAttribute('class', 'form-control');
                elements.shortDescInput.setAttribute('type', 'text');
                elements.shortDescInput.setAttribute('placeholder', OpenLayers.Lang.translate('I.ex.') + ': ' + OpenLayers.Lang.translate('"Stores in Hordaland"'));
                ...
                elements.shortDescExplanation = document.createElement('div');
                elements.shortDescExplanation.setAttribute('class', 'form-help');
                elements.shortDescExplanation.innerHTML = OpenLayers.Lang.translate('A short description is shown when the mouse cursor is held over the embedded map.');
                panel.appendChild(elements.shortDescExplanation);

                elements.longDescLabel = document.createElement('label');
                elements.longDescLabel.setAttribute('for', 'long-desc');
                elements.longDescLabel.setAttribute('class', 'lbl');
                ...
                elements.longDescInput.setAttribute('class', 'form-control');
                ...
                elements.longDescExplanation = document.createElement('div');
                elements.longDescExplanation.setAttribute('class', 'form-help');
                elements.longDescExplanation.innerHTML = OpenLayers.Lang.translate('A long description is used when there is an error, or when the user is unable to see the map.');
                panel.appendChild(elements.longDescExplanation);
