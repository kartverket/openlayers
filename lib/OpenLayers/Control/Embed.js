...
OpenLayers.Control.Embed = 
    ...
    translateMaskToFeature: function(){
        ...
        var self = this, size, outerBounds, innerBounds, polygon, 
            featureMask, el, tl, tr, bl, br, p1, p2, p3, p4, pts = [];
        ...
        featureMask = new OpenLayers.Feature.Vector(polygon, {}, null);

        self.maskLayer.addFeatures([featureMask]);

        // Preserve feature mask despite map changes
        self.map.events.unregister('move', self, self.translateMaskToFeature);
        self.map.events.unregister('zoomend', self, self.translateMaskToFeature);
        self.map.events.register('move', self, self.translateMaskToFeature);
        self.map.events.register('zoomend', self, self.translateMaskToFeature);
