...
OpenLayers.Control.Embed = 
    ...
    steps: {
        ...
        preview: {
            draw: function () {
                ...
                shortDesc = (this.data.shortDesc) ? this.data.shortDesc : '';
                longDesc  = (this.data.longDesc) ? this.data.longDesc : '';
                ...
                elements.shortDesc.innerHTML = '<h3 class="h">' + OpenLayers.Lang.translate('Short description:') + '</h3><span>' + shortDesc + '</span>';
                panel.appendChild(elements.shortDesc);

                elements.longDesc = document.createElement('section');
                elements.longDesc.innerHTML = '<h3 class="h">' + OpenLayers.Lang.translate('Long description:') + '</h3><span>' + longDesc + '</span>';
	...
	*/
    ...
    updatePoints: function(){
        ...
        console.log(self.data.centerX, self.data.centerY);
