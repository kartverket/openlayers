...
OpenLayers.Control.HeightProfile = OpenLayers.Class(OpenLayers.Control, {
	...
	initialize: function (options) {
		...
		OpenLayers.Util.extend(OpenLayers.Lang.nb, {
            'Generating height profile visualization': 'Genererer høydeprofil-visualisering',
            'Your height profile': 'Din høydeprofil',
            'Close' : 'Lukk',
            'Open PDF' : 'Åpne PDF'
        });
	...
	showProfileLightbox: function(){
        ...
        self.profileLBSaveBtn.innerHTML = OpenLayers.Lang.translate('Open PDF');;
