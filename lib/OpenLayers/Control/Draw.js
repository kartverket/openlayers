...
OpenLayers.Control.Draw = OpenLayers.Class(OpenLayers.Control, {
    ...
    showLineMeasures: function () {
        ...
        OpenLayers.Element.removeClass(this.measures.wrapper, 'area');
        this.measures.length.innerHTML = OpenLayers.Lang.translate('Length');
    },
    showAreaMeasures: function () {
        OpenLayers.Element.removeClass(this.measures.wrapper, 'point');
        OpenLayers.Element.removeClass(this.measures.wrapper, 'line');
        OpenLayers.Element.addClass(this.measures.wrapper, 'area');
        this.measures.length.innerHTML = OpenLayers.Lang.translate('Circumference');
    },
    ...
    updateMeasures: function (evt) {
        ...
        OpenLayers.Lang.translate('N');
        OpenLayers.Lang.translate('S');
        OpenLayers.Lang.translate('E');
        OpenLayers.Lang.translate('V');
        this.measures.lon.data.innerHTML = Math.abs(preciseRound(lonLat.lon, 5)) + '° ' + ((lonLat.lon > 0) ? 'Ø' : 'V');
        this.measures.lon.data.setAttribute('title', lonLat.lon + '° ' + ((lonLat.lon > 0) ? 'Ø' : 'V'));
        this.measures.lat.data.innerHTML = Math.abs(preciseRound(lonLat.lat, 5)) + '° ' + ((lonLat.lat > 0) ? 'N' : 'S');
        this.measures.lat.data.setAttribute('title', lonLat.lat + '° ' + ((lonLat.lat > 0) ? 'Ø' : 'V'));
