...
OpenLayers.Control.Geoportal = OpenLayers.Class(OpenLayers.Control, {
  ...
  showControls: function (url) {
    ...
    html += '<div class="header" id="tabs-container"><h1 class="h">'+OpenLayers.Lang.translate('Thematic overlays')+'</h1>';
    html += '<a href="#showLayersTab" id="showLayer">'+OpenLayers.Lang.translate('Layer list')+'</a>&nbsp;&mdash;&nbsp;';
    html += '<a href="#legendTab" id="legend">'+OpenLayers.Lang.translate('Legends')+'</a>';
    html += '<div class="tab">';
    ...
    $("#legend").click(this, function (event) { 
      event.preventDefault();
