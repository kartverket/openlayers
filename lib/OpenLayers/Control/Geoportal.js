...
OpenLayers.Control.Geoportal = OpenLayers.Class(OpenLayers.Control, {
  ...
  showControls: function (url) {
    ...
    html += '<span style="margin-top:3px">WMS: <input checked name="type" type="radio" value="wms"/> WFS: <input name="type" type="radio" value="wfs"/></span>';
    ...
    html += '</div>';
    html += '<div class="buttons-panel" id="buttonTab"><button class="back" id="backButton">Forrige</button><button class="next" id="nextButton">'+OpenLayers.Lang.translate('Next')+'</button></div>';
    html += '</div>';
  ...
  getLayers: function () {
    ...
    var type = document.getElementById('geoportal-form')["type"].value;
    if (type == "wms") {
