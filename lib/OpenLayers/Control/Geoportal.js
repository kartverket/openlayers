...
OpenLayers.Control.Geoportal = OpenLayers.Class(OpenLayers.Control, {
  ...
  showControls: function () {
    ...
    html += '<div class="header" id="tabs-container">WMS tjeneste';
    html += '<header><ol class="type-active tabs-menu">';
    html += '<li class="tjenesteTab"><span class="step-number"><a href="#addLayerTab" id="addLayer">1</a></span> of <span>3</span><span class="step-label">tjeneste</span></li>';
    ...
    html += '<li class="legendTab"><span class="step-number"><a href="#legendTab" id="legend">3</a></span> of <span>3</span><span class="step-label">Tegnforklaring</span></li>';
    html += '</ol></header>';
    html += '<div class="tab">';
    ...
    html += '<input id="geoportalUrl" type="url" style="width: 324px;"><button id="geoportalUrl-submit" type="button">koble til</button>';
    html += '</form>';
    html += '</div>';
    html += '<div class="tab-content" id="showLayersTab"><div id="layerList" style="height: 300px;  width:436px; overflow-y: scroll;"></div></div>';
    html += '<div class="tab-content" id="legendTab"><div id="legendBox" style="height: 300px;">Ingen tegnforklaring</div></div>';
    html += '</div>';
