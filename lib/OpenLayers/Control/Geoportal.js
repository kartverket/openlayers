...
OpenLayers.Control.Geoportal = OpenLayers.Class(OpenLayers.Control, {
  ...
  showControls: function (url) {
    ...
    html += '<div class="header" id="tabs-container"><h1 class="h">'+OpenLayers.Lang.translate('Overlays')+'</h1>';
    html += '<header><ol class="type-active tabs-menu">';
    html += '<li class="lagTab"><span class="step-number"><a href="#showLayersTab" id="showLayer">1</a></span> of <span>3</span><span class="step-label">'+OpenLayers.Lang.translate('Layer')+'</span></li>';
    html += '<li class="legendTab"><span class="step-number"><a href="#legendTab" id="legend">2</a></span> of <span>3</span><span class="step-label">'+OpenLayers.Lang.translate('Legend')+'</span></li>';
    html += '</ol></header>';
    html += '<div class="tab">';
