...
OpenLayers.Control.Geoportal = OpenLayers.Class(OpenLayers.Control, {
  ...
  showControls: function () {
    ...
    html += '<li class="current"><a href="#addLayerTab" id="addLayer">Legg til tjeneste</a></li>';
    html += '<li><a href="#showLayersTab" id="showLayer">velg lag</a></li>';
    html += '<li><a href="#legendTab" id="legend">Tegnforklaring</a></li>';
    html += '</ul>';
    html += '<div class="tab">';
    ...
    html += '<div class="tab-content" id="legendTab"><div id="legendBox">Ingen tegnforklaring</div></div>';
    html += '</div>';
    html += '</div>';
