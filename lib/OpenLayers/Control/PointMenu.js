...
OpenLayers.Control.PointMenu = OpenLayers.Class( OpenLayers.Control, {
    ...
    measure : function (e) {
    	var self,
            ...
            if (!!self.map){
                if(self.map.getLayersByName("Sj&oslash;")[0].getVisibility()) {
    ...
    displayInformation : function (text) {
    	var self, 
			...
			coordinates.appendChild(northLabel);
                        ...
                        if ((crsChoice == "84") || (crsChoice=="50")) {
  			  northLabel.innerHTML = OpenLayers.Lang.translate('Longitude') + ':';
			  eastLabel.innerHTML = OpenLayers.Lang.translate('Latitude') + ':';
                        } else {
