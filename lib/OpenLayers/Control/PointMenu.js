...
OpenLayers.Control.PointMenu = OpenLayers.Class(OpenLayers.Control, {
  ...
  displayRuler: function () {
    ...
    self.insertDrawPoint([attr['lon'], attr['lat']], [attr['lon'], attr['lat']], true); // Change the second attr['lat'] to 15806506 parameter to add a ruler pointing "north"
  ...
  measure: function (e) {
    ...
    /* Calculate the angle between ruler and "north":
    ...
    widget.innerHTML = '<ul class="measureContent">' +
      ...
      sjoMeasure +
      '</li>' +
      /* Uncomment to show the angle between the ruler and "north"
