...
OpenLayers.Control.PointMenu = 
	...
	// EPSG:4326
	/*
	var lonlat = new OpenLayers.LonLat(20,37)
	    .transform(new OpenLayers.Projection("EPSG:4326"),new OpenLayers.Projection("EPSG:900913"));
	self.map.setCenter(lonlat);
	//self.map.zoomTo(4);

	return  self._kiet('done..');
	*/
	...
	if ( actived ) {
	    attr['menuBFopenCallback'] = function(){self.map.setCenter(attr['center']);};
	    /*
	    ...
	    */
	    ...
	    attr['ignorMove'] = true;	
	    setTimeout( function() { attr['ignorMove'] = false;}, 100);
