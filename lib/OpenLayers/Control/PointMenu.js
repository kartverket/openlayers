...
OpenLayers.Control.PointMenu = 
	...
	*/
	...
	var centralize = function() {
	    ...
	    var h = 400, s = OpenLayers.Util.getWindowSize(), w = [
	...
	*/
	...
	// placename
	if ( data['placename'] && data['placename']['value'] ) {
	    out.push( 
		'<li class="data placename">'+
	...
	out.push(
		...
		'<span class="value lonlat">'+attr['lon']+', '+attr['lat']+ '</span>'+
	    '</li>'
	);
