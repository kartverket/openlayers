...
OpenLayers.Control.PointMenu = OpenLayers.Class( OpenLayers.Control, {
	...
	_kiet: function (text, value) {
        ...
        debug = document.getElementById('debugWidget');
        v = '';
        d = new Date();
        ...
        if (!debug) {
            ...
            debug.setAttribute('style', 'position:fixed;right:10px;top:10px;height:200px;width:400px;overflow:scroll;background-color:white;color:black;z-index:10000;font-size:11px');
