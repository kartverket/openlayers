...
OpenLayers.Control.PointMenu = OpenLayers.Class( OpenLayers.Control, {
	...
	{'id'   : 'PMweather',
	 ...
	 'cnt'  : '<div class="loading">Laster...</div>',
	 'api'  : [
	     {'id':'weather', 'url':'/ws/forecast.py'},
	     {'id':'sunRise', 'url':'/ws/sun.py'}
	 ]
	},
	{'id'   : 'PMruler',
	 'title': 'M&aring;ling',
	...
	{'id'   : 'PMshare',
	 ...
	 'cnt'  : '<div class="loading">Laster...</div>',
	 'api'  : [
	     {'id':'property', 'url':'/ws/wfs.teig.py'}
	 ]
        },
	...
	*/
    ...
    draw: function () {
		...
		self.map.events.register('click', self, function(evt){
    ...
    displayRuler : function() {
        ...
        OpenLayers.Element.addClass(self, 'display')
        self.toggleMenu(true);
    }, // displayRuler
