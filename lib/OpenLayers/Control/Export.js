...
OpenLayers.Control.Export = 
 ...
 /*                   if (!NK.ticket || (NK.ticketedService != service) || (new Date().getTime() - NK.ticketIssued > 3600000 )) {
                    ...
                    elements.link.innerHTML = "<td colspan=2>"+OpenLayers.Lang.translate("Preview")+":<br/><a target='_blank' style='color:#fff' href='"+WMS_URL+"'>"+preview+"<br/>"+OpenLayers.Lang.translate("Download dataset from source")+"</td>";
                  } else {
