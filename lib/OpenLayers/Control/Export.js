        ...
        format: {
            draw: function () {
                ...
                function updateLayerSelector() { 
                  ...
                  for (var l in layers) {
                    code += '<option value="'+layers[l].name+'">'+layers[l].name+'</option>';
                  }
                  code += "</select></td>";
