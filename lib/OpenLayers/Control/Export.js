    ...
    steps: {
        ...
        format: {
	        ...
	        var size = this.getSizeOfPoints( points );
                ...
                code += "<option value='image/svg+xml'>SVG</option>";
                ...
                var updateLink = function (evt) { 
                  ...
                  var WMS_URL;
                  if ((format == "image/geotiff") || (format=="application/x-pdf")) {
                  ...
                  var preview = "<img border=0 width="+prev_x+" height="+hratio+" src='http://openwms.statkart.no/skwms1/"+service+"?styles=&service=WMS&request=GetMap&SRS=EPSG:32633&FORMAT="+preview_format+"&BGCOLOR=0xFFFFFF&TRANSPARENT=TRUE&LAYERS="+layers+"&VERSION=1.1.1&WIDTH="+prev_x+"&HEIGHT="+hratio+"&BBOX="+bbox+"'/>";
