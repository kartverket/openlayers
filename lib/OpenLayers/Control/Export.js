	        ...
	        var size = this.getSizeOfPoints( points );
                ...
                var updateLink = function (evt) { 
                  ...
                  if (format == "geojpeg") {
                    ...
                    WMS_URL = "http://www.norgeskart.no/ws/geoimage.py?url=" + encodeURIComponent(BASE_URL+"styles=&service=WMS&request=GetMap&SRS=EPSG:32633&FORMAT=image/jpeg&BGCOLOR=0xFFFFFF&TRANSPARENT=TRUE&LAYERS="+layers+"&VERSION=1.1.1&WIDTH="+width+"&HEIGHT="+height+"&BBOX="+bbox)+"&px="+px+"&py="+py+"&x="+x+"&y="+y;
                  } else {
                  ...
                  preview += " src='"+BASE_URL+"styles=&service=WMS&request=GetMap&SRS=EPSG:32633&FORMAT="+preview_format+"&BGCOLOR=0xFFFFFF&TRANSPARENT=TRUE&LAYERS="+layers+"&VERSION=1.1.1&WIDTH="+prev_x+"&HEIGHT="+hratio+"&BBOX="+bbox+"'/>";
                  if (a4) {
