...
OpenLayers.Control.Export = 
    ...
    initialize: function(options) {
        ...
        this.title = OpenLayers.Lang.translate('Export maps');
        this.widgetStates = {};
    ...
    steps: {
        ...
        format: {
	        ...
	        var size = this.getSizeOfPoints( points );
                ...
                code = "<select style='margin-right: 3px'>";
                ...
                code += "<option value='"+a4scale+"'>Tilpasset A4 ("+OpenLayers.Util.preciseRound(size[0]*a4scale*PX_TO_CM,2)+"x"+OpenLayers.Util.preciseRound(size[1]*a4scale*PX_TO_CM,2)+"cm)</option>";
                ...
                code = "<select style='margin-top:3px'>";
                ...
                var updateLink = function (evt) { 
                  ...
                  if (a4) {
                    ...
                    var padt = Math.max(0, (bgh - hratio) / 2);
