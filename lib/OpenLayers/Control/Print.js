  ...
  OpenLayers.Class(OpenLayers.Control, {
    ...
    steps: {
      format: {
        draw: function () {
          ...
          + '  <span id="helpBlock" class="help-block">Tittelen er for lang.</span>'
          + '</div>'
          + '<div class="checkbox">'
          + '  <label>'
    ...
    sendPrint: function (geometry) {
        ...
        $.ajax({
          ...
          document.getElementById('overlay').innerHTML = '<div class="content"><p>Error</p><p>' + textStatus + '</p><button aria-label="Close" class="close abs" onclick="document.getElementById(\'overlay\').style.display = \'none\'" style="position: absolute;" type="button"><span aria-hidden="true">×</span></button></div>';
        }).done(function (response) {
          "use strict";
          document.getElementById('overlay').innerHTML = '<div class="content"><p>Kartet ditt er ferdig!</p><p><a class="btn btn-sm btn-success btn-block" href="' + host + response.linkPdf + '" target="_blank">Last ned</a></p><button aria-label="Close" class="close" onclick="document.getElementById(\'overlay\').style.display = \'none\'" style="position: absolute;" type="button"><span aria-hidden="true">×</span></button></div>';
        });
    }, // sendPrint
