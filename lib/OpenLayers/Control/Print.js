    ...
    steps: {
      format: {
        draw    : function () {
          ...
          elements.annet.innerHTML = '<div class="form-group"><label for="ol-print-title">Velg tittel</label><input class="form-control" type="text" id="ol-print-title" placeholder="Turkart" value="" /></div>';
          ...
          elements.legend.innerHTML = '<div class="checkbox"><label><input type="checkbox" id="ol-print-legend" value="1"> Legg til tegnforklaring</label></div>';
