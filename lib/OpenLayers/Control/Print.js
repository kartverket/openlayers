...
OpenLayers.Control.Print =
  OpenLayers.Class(OpenLayers.Control, {
    ...
    sendPrint: function (geometry) {
        ...
        var popupSize = new OpenLayers.Size(150, 100);
        var popup = new OpenLayers.Popup.FramedSideAnchored('nk-selected-coverage-map', map.getCenter(), popupSize, 'Vi lager kartet ditt! Vennligst vent...', null, true, null, null, 'print-message-popup');
        ...
        $.ajax({
          ...
          "use strict";
          document.getElementById('nk-selected-coverage-map_contentDiv').innerHTML = '<p>Kartet ditt er ferdig!</p><p><a class="btn btn-success btn-block" href="' + host + response.linkPdf + '" target="_blank">Last ned</a></p>';
        });
    }, // sendPrint
