    ...
    sendPrint: function (geometry) {
        ...
        var params = {
          map: {
            ...
            ,dpi: '300'
            ,layers: [{
              baseURL: 'http://openwms.statkart.no/skwms1/wms.toporaster3'
              ,customParams: {
                'TRANSPARENT': 'false'
              }
