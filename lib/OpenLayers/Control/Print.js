...
OpenLayers.Control.Print =
  OpenLayers.Class(OpenLayers.Control, {
    ...
    steps: {
      format: {
        draw: function () {
          this.nextButton.innerHTML = 'Lag kartet!'; //OpenLayers.Lang.translate('Print');
          //this.printFrame();
          ...
          var content = ''
          + '<p>Flytt kartet slik at det gule feltet dekker området du ønsker å skrive ut.</p>'
          ...
          + '</div>'
          + '<div class="form-group form-group-sm">'
          + '  <label for="ol-print-title">Gi kartet ditt et navn</label>'
          + '  <input type="text" class="form-control" id="ol-print-title" placeholder="Turkart">'
          + '</div>'
          + '<div class="checkbox">'
          + '  <label>'
          + '    <input type="checkbox" id="ol-print-legend" value="1"> Ta med tegnforklaringer'
          + '  </label>'
          + '</div>';
    ...
    printFrame: function () {
      ...
      var olPrintScale = document.getElementById('ol-print-scale');
      var scale = olPrintScale === null ? 50000 : parseInt(olPrintScale.value);
      ...
      attributes.tilt = Math.atan2((l2.y - l1.y), (l2.x - l1.x)) * 180 / Math.PI;
      attributes.sone = null;
    ...
    sendPrint: function (geometry) {
        ...
        + '<p>Vi lager kartet ditt!</p><p>Vennligst vent...</p>'
        ...
        + '<p><button class="btn btn-block btn-xs btn-danger" onclick="document.getElementById(\'overlay\').style.display = \'none\'">Avbryt</button></p>'
        + '</div>';
        ...
        var params = {
          ...
          ,paging: 12
          ,layout: 'A4 landscape'
          ,scale: document.getElementById('ol-print-scale').value || 50000
        ...
        $.ajax({
          ...
          document.getElementById('overlay').innerHTML = '<div class="content"><p>Error</p><p>' + textStatus + '</p><p><button class="btn btn-block btn-xs btn-default" onclick="document.getElementById(\'overlay\').style.display = \'none\'">Lukk</button></p>';
        }).done(function (response) {
          "use strict";
          document.getElementById('overlay').innerHTML = '<div class="content"><p>Kartet ditt er ferdig!</p><p><a class="btn btn-sm btn-success btn-block" href="' + host + response.linkPdf + '" target="_blank">Last ned</a></p><p><button class="btn btn-block btn-xs btn-default" onclick="document.getElementById(\'overlay\').style.display = \'none\'">Ferdig</button></p></div>';
        });
    }, // sendPrint
