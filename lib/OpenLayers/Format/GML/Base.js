...
OpenLayers.Format.GML.Base = OpenLayers.Class(OpenLayers.Format.XML, {
    ...
    readNode: function(node, obj, first) {
        ...
        //if (!this.featureNS && (!(node.prefix in this.namespaces) && ... With featureNS given as config,
        // childnodes would be on wrong namespace and therfor no features found.
        if ((!(node.prefix in this.namespaces) &&
